...
$c_Lcalculator_Calculator$.prototype.calculator$Calculator$$isCyclic$1__Lcalculator_Expr__sci_Set__sci_Map__Z = (function(expr, visited, namedExpressions$1) {
  _isCyclic: while (true) {
    var rc10 = false;
    var x3 = null;
    var x1 = expr;
    ...
    if ($is_Lcalculator_Ref(x1)) {
      ...
      var vName = x3.name$2;
      if ($s_sc_MapLike$class__contains__sc_MapLike__O__Z(namedExpressions$1, vName)) {
        if (visited.contains__O__Z(vName)) {
          return true
        } else {
          var temp$expr = $as_Lcalculator_Expr($as_Lcalculator_Signal(namedExpressions$1.apply__O__O(vName)).apply__O());
          var temp$visited = $as_sci_Set(visited.$$plus__O__sc_Set(vName));
          expr = temp$expr;
    ...
    if (rc10) {
      var vName$2 = x3.name$2;
      if ((!$s_sc_MapLike$class__contains__sc_MapLike__O__Z(namedExpressions$1, vName$2))) {
        return false
      }
    };
    if ($is_Lcalculator_Plus(x1)) {
      ...
      var exprA = x5.a$2;
      var exprB = x5.b$2;
      if (this.calculator$Calculator$$isCyclic$1__Lcalculator_Expr__sci_Set__sci_Map__Z(exprA, visited, namedExpressions$1)) {
        return true
      } else {
        expr = exprB;
        continue _isCyclic
    ...
    if ($is_Lcalculator_Minus(x1)) {
      ...
      var exprA$2 = x6.a$2;
      var exprB$2 = x6.b$2;
      if (this.calculator$Calculator$$isCyclic$1__Lcalculator_Expr__sci_Set__sci_Map__Z(exprA$2, visited, namedExpressions$1)) {
        return true
      } else {
        expr = exprB$2;
        continue _isCyclic
    ...
    if ($is_Lcalculator_Times(x1)) {
      ...
      var exprA$3 = x7.a$2;
      var exprB$3 = x7.b$2;
      if (this.calculator$Calculator$$isCyclic$1__Lcalculator_Expr__sci_Set__sci_Map__Z(exprA$3, visited, namedExpressions$1)) {
        return true
      } else {
        expr = exprB$3;
        continue _isCyclic
    ...
    if ($is_Lcalculator_Divide(x1)) {
      ...
      var exprA$4 = x8.a$2;
      var exprB$4 = x8.b$2;
      if (this.calculator$Calculator$$isCyclic$1__Lcalculator_Expr__sci_Set__sci_Map__Z(exprA$4, visited, namedExpressions$1)) {
        return true
      } else {
        expr = exprB$4;
        continue _isCyclic
...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    if ($is_Lcalculator_Ref(x1)) {
      ...
      x3 = $as_Lcalculator_Ref(x1);
      var vName = x3.name$2;
      if ($s_sc_MapLike$class__contains__sc_MapLike__O__Z(references, vName)) {
        expr = $as_Lcalculator_Expr($as_Lcalculator_Signal(references.apply__O__O(vName)).apply__O());
        continue _eval
      }
    };
    if (rc10) {
      var vName$2 = x3.name$2;
      if ((!$s_sc_MapLike$class__contains__sc_MapLike__O__Z(references, vName$2))) {
        return (NaN)
      }
    };
    if ($is_Lcalculator_Plus(x1)) {
      ...
      var exprA = x5.a$2;
      var exprB = x5.b$2;
      var a = this.eval__Lcalculator_Expr__sci_Map__D(exprA, references);
      var b = this.eval__Lcalculator_Expr__sci_Map__D(exprB, references);
    ...
    if ($is_Lcalculator_Minus(x1)) {
      ...
      var exprA$2 = x6.a$2;
      var exprB$2 = x6.b$2;
      var a$1 = this.eval__Lcalculator_Expr__sci_Map__D(exprA$2, references);
      var b$1 = this.eval__Lcalculator_Expr__sci_Map__D(exprB$2, references);
      return (((a$1 !== a$1) || (b$1 !== b$1)) ? (NaN) : (a$1 - b$1))
    };
    if ($is_Lcalculator_Times(x1)) {
      var x7 = $as_Lcalculator_Times(x1);
      var exprA$3 = x7.a$2;
      var exprB$3 = x7.b$2;
      var a$2 = this.eval__Lcalculator_Expr__sci_Map__D(exprA$3, references);
      var b$2 = this.eval__Lcalculator_Expr__sci_Map__D(exprB$3, references);
      return (((a$2 !== a$2) || (b$2 !== b$2)) ? (NaN) : (a$2 * b$2))
    };
    if ($is_Lcalculator_Divide(x1)) {
      var x8 = $as_Lcalculator_Divide(x1);
      var exprA$4 = x8.a$2;
      var exprB$4 = x8.b$2;
      var a$3 = this.eval__Lcalculator_Expr__sci_Map__D(exprA$4, references);
      var b$3 = this.eval__Lcalculator_Expr__sci_Map__D(exprB$4, references);
      return (((a$3 !== a$3) || (b$3 !== b$3)) ? (NaN) : (a$3 / b$3))
    };
    throw new $c_s_MatchError().init___O(x1)
  }
});
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$1, delta$1) {
    return (function() {
      if (($uD(delta$1.apply__O()) < 0)) {
        ...
        var res1 = ((((-jsx$2) + $uD($g["Math"]["sqrt"](a$1))) / 2) * $uD(a$2.apply__O()));
        var jsx$3 = $uD(b$1.apply__O());
        var a$3 = $uD(delta$1.apply__O());
        var res2 = ((((-jsx$3) - $uD($g["Math"]["sqrt"](a$3))) / 2) * $uD(a$2.apply__O()));
        var array$1 = [res1, res2];
...
$c_Lcalculator_Polynomial$.prototype.computeDelta__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c) {
  $m_Lcalculator_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$1, c$1) {
    return (function() {
      return (($uD(a$1.apply__O()) * $uD(a$1.apply__O())) - ((4 * $uD(a$1.apply__O())) * $uD(c$1.apply__O())))
    })
  })(a, c));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
...
$c_Lcalculator_TweetLength$.prototype.tweetRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(tweetText) {
  $m_Lcalculator_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(tweetText$1, MAX_LOW_SURROGATE$1, MIN_LOW_SURROGATE$1, MAX_HIGH_SURROGATE$1, MIN_HIGH_SURROGATE$1) {
    return (function() {
      var text = $as_T(tweetText$1.apply__O());
      var jsx$1 = $m_Lcalculator_TweetLength$();
      var xs = $m_sjsr_RuntimeString$().toCharArray__T__AC(text);
      var this$2 = $m_sci_List$();
      var cbf = this$2.ReusableCBFInstance$2;
      var b = cbf.apply__scm_Builder();
      b.sizeHint__I__V(xs.u["length"]);
      b.$$plus$plus$eq__sc_TraversableOnce__scg_Growable(new $c_scm_WrappedArray$ofChar().init___AC(xs));
      var count = jsx$1.calculator$TweetLength$$checkSize$1__sci_List__I__C__C__C__C__I($as_sci_List(b.result__O()), $uI(text["length"]), MAX_LOW_SURROGATE$1, MIN_LOW_SURROGATE$1, MAX_HIGH_SURROGATE$1, MIN_HIGH_SURROGATE$1);
      return ((140 - count) | 0)
    })
  })(tweetText, 57343, 56320, 56319, 55296));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
$c_Lcalculator_TweetLength$.prototype.isLowSurrogate$1__p1__C__C__C__Z = (function(ch, MAX_LOW_SURROGATE$1, MIN_LOW_SURROGATE$1) {
  return ((ch >= MIN_LOW_SURROGATE$1) && (ch < ((1 + MAX_LOW_SURROGATE$1) | 0)))
});
$c_Lcalculator_TweetLength$.prototype.isHighSurrogate$1__p1__C__C__C__Z = (function(ch, MAX_HIGH_SURROGATE$1, MIN_HIGH_SURROGATE$1) {
  return ((ch >= MIN_HIGH_SURROGATE$1) && (ch < ((1 + MAX_HIGH_SURROGATE$1) | 0)))
});
...
$c_Lcalculator_TweetLength$.prototype.calculator$TweetLength$$checkSize$1__sci_List__I__C__C__C__C__I = (function(chars, curSize, MAX_LOW_SURROGATE$1, MIN_LOW_SURROGATE$1, MAX_HIGH_SURROGATE$1, MIN_HIGH_SURROGATE$1) {
  _checkSize: while (true) {
    var rc8 = false;
    var x2 = null;
    var x1 = chars;
    if ($is_sci_$colon$colon(x1)) {
      ...
      if ($is_sci_$colon$colon(p3)) {
        ...
        if ((c$1 === null)) {
          ...
          var c2 = this$4.value$1
        };
        var cs = x4.tl$5;
        if ((this.isHighSurrogate$1__p1__C__C__C__Z(c1, MAX_HIGH_SURROGATE$1, MIN_HIGH_SURROGATE$1) && this.isLowSurrogate$1__p1__C__C__C__Z(c2, MAX_LOW_SURROGATE$1, MIN_LOW_SURROGATE$1))) {
          var temp$curSize = (((-1) + curSize) | 0);
          chars = cs;
          curSize = temp$curSize;
          continue _checkSize
        } else {
          var x = new $c_jl_Character().init___C(c2);
          chars = new $c_sci_$colon$colon().init___O__sci_List(x, cs);
          continue _checkSize
        }
      }
    };
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T2__T2 = (function(kv) {
  matchEnd5: {
    var x$1_$_$$und1$f;
    var x$1_$_$$und2$f;
    if ((kv !== null)) {
      var k = $as_T(kv.$$und1$f);
      var v = $as_Lcalculator_Signal(kv.$$und2$f);
      if ((k !== null)) {
        if ((v !== null)) {
          var x$1_$_$$und1$f = k;
          var x$1_$_$$und2$f = v;
  ...
  var k$2 = $as_T(x$1_$_$$und1$f);
  var v$2 = $as_Lcalculator_Signal(x$1_$_$$und2$f);
  var jsx$3 = $m_Lcalculator_Calculator$();
  var jsx$2 = $as_Lcalculator_Expr(v$2.apply__O());
  var array = [k$2];
  if (($uI(array["length"]) === 0)) {
    var jsx$1 = $m_sci_Set$EmptySet$()
  } else {
  ...
  if (jsx$3.calculator$Calculator$$isCyclic$1__Lcalculator_Expr__sci_Set__sci_Map__Z(jsx$2, $as_sci_Set(jsx$1), this.namedExpressions$1$f)) {
    $m_Lcalculator_Signal$();
    ...
    var signal = new $c_Lcalculator_Signal().init___F0(expr$1)
  };
  return new $c_T2().init___O__O(k$2, signal)
});
